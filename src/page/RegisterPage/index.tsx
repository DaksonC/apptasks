...
export function RegisterPage() {
  const [model, setModal] = useState<IUsers>({
    id: 0,
    name: "",
    email: "",
    password: "",
              ...
              >
                ...
                >
                  <option value="Development">
                    {model.departament.options}
                  </option>
                  <option value="IA">{model.departament.options}</option>
                  <option value="RPA">{model.departament.options}</option>
                  <option value="UX">{model.departament.options}</option>
                </Select>
                <Button
                  w="100%"
                  h="50px"
